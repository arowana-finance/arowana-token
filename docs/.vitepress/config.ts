...
export const REPO = pkgJson.repository?.url
    ...
    : 'https://github.com/arowana-finance';
export const HOMEPAGE = REPO || 'https://github.com/arowana-finance';
export const NPMJS = `https://npmjs.com/package/${pkgJson.name}`;
export const LOGO = '/logo.png';
export const LICENSE = pkgJson.license || 'MIT';
export const COPYRIGHT = `Copyright © 2025 ${pkgJson.author || 'Arowana Finance'}`;
