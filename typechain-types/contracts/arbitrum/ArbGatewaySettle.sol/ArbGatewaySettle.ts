...
export interface ArbGatewaySettleInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "initializeGatewaySettle",
    values: [
      AddressLike,
      AddressLike,
      AddressLike,
  ...
  encodeFunctionData(
    functionFragment: "setAutoSettle",
    values?: undefined,
  ): string;
  encodeFunctionData(
...
export namespace SetAutoSettleEvent {
  export type InputTuple = [autoSettle: boolean];
  export type OutputTuple = [autoSettle: boolean];
  export interface OutputObject {
    autoSettle: boolean;
  }
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export interface ArbGatewaySettle extends BaseContract {
  ...
  setAutoSettle: TypedContractMethod<[], [void], "nonpayable">;
  ...
  >;
  getFunction(
    nameOrSignature: "initializeGatewaySettle",
  ): TypedContractMethod<
    [
      _owner: AddressLike,
      _inbox: AddressLike,
  ...
  getEvent(
    ...
    SetAutoSettleEvent.InputTuple,
    SetAutoSettleEvent.OutputTuple,
    SetAutoSettleEvent.OutputObject
  >;
  getEvent(
    key: "SetOtherToken",
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "SetAutoSettle(bool)": TypedContractEvent<
      SetAutoSettleEvent.InputTuple,
      SetAutoSettleEvent.OutputTuple,
      SetAutoSettleEvent.OutputObject
    >;
    SetAutoSettle: TypedContractEvent<
      SetAutoSettleEvent.InputTuple,
      SetAutoSettleEvent.OutputTuple,
      SetAutoSettleEvent.OutputObject
    >;
