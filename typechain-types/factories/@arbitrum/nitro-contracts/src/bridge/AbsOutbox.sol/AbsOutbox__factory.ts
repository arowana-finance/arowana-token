...
import type {
  AbsOutbox,
  AbsOutboxInterface,
} from "../../../../../../@arbitrum/nitro-contracts/src/bridge/AbsOutbox.sol/AbsOutbox.js";
...
export class AbsOutbox__factory {
  ...
  static createInterface(): AbsOutboxInterface {
    return new Interface(_abi) as AbsOutboxInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): AbsOutbox {
    return new Contract(address, _abi, runner) as unknown as AbsOutbox;
  }
}
