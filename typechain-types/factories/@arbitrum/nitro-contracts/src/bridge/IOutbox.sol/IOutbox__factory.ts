...
import type {
  IOutbox,
  IOutboxInterface,
} from "../../../../../../@arbitrum/nitro-contracts/src/bridge/IOutbox.sol/IOutbox.js";
...
export class IOutbox__factory {
  ...
  static createInterface(): IOutboxInterface {
    return new Interface(_abi) as IOutboxInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IOutbox {
    return new Contract(address, _abi, runner) as unknown as IOutbox;
  }
}
